 ...
 */
class Salle extends \Basket\DatabaseBundle\Entity\Salle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Basket\\DatabaseBundle\\Entity\\Salle' . "\0" . 'id', '' . "\0" . 'Basket\\DatabaseBundle\\Entity\\Salle' . "\0" . 'nom', '' . "\0" . 'Basket\\DatabaseBundle\\Entity\\Salle' . "\0" . 'adresse');
        }
